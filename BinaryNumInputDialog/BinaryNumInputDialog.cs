...
namespace System.Windows.Forms
{
    ...
    /// 二进制数字输入对话框
    /// </summary>
    public partial class BinaryNumInputDialog : Form
    {

        public BinaryNumInputDialog()
        {
            InitializeComponent();
        ...
        /// <summary>
        /// 数值为 1 的位置下标，下标数值由大到小排列
        /// </summary>
        public int[] IndexsOfOne
        {
            get
            {
        ...
        public string BinaryString
        {
            get
            {
                var indexsOfOne = IndexsOfOne;

                // 如果长度为 0， 返回空字符串
                if(indexsOfOne.Length == 0)
                {
                    return "0";
                }
